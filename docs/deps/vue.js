  ...
  */
	...
	function inject(key, defaultValue, treatDefaultAsFactory = false) {
		...
		if (instance) {
			...
			const provides =
				instance.parent == null ? instance.vnode.appContext && instance.vnode.appContext.provides : instance.parent.provides;
	...
	function hasMultipleChildren(node) {
		...
		const child = children[0];
		return (
			children.length !== 1 || child.type === 11 /* FOR */ || (child.type === 9 /* IF */ && child.branches.some(hasMultipleChildren))
		);
	}
